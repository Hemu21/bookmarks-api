...
@book.get('/list')
@jwt_required()
@swag_from(r'https://github.com/Hemu21/bookmarks-api/tree/master/src/docs/bookmark/get_all.yml')
def book_list():
...
@jwt_required()
@swag_from(r'https://github.com/Hemu21/bookmarks-api/tree/master/src/docs/bookmark/get_short_url.yml')
def show(short_url):
...
@jwt_required()
@swag_from(r'https://github.com/Hemu21/bookmarks-api/tree/master/src/docs/bookmark/put_url.yml')
...
@jwt_required()
@swag_from(r'https://github.com/Hemu21/bookmarks-api/tree/master/src/docs/bookmark/put_short_url.yml')
...
@book.post('/add')
@jwt_required()
@swag_from(r'https://github.com/Hemu21/bookmarks-api/tree/master/src/docs/url.yml')
def book_add():
    user_id=get_jwt_identity()
...
@book.delete('/delete')
@jwt_required()
@swag_from(r'https://github.com/Hemu21/bookmarks-api/tree/master/src/docs/bookmark/delete_all.yml')
def book_delete():
    user_id=get_jwt_identity()
...
@jwt_required()
@swag_from(r'https://github.com/Hemu21/bookmarks-api/tree/master/src/docs/bookmark/delete_short_url.yml')
...
@book.get('/list/stat')
@jwt_required()
@swag_from(r'https://github.com/Hemu21/bookmarks-api/tree/master/src/docs/bookmark/stat.yml')
def stats():
    user_id=get_jwt_identity()
    bookmk=bookmark.query.filter_by(user_id=user_id).all()
    if not bookmk:
